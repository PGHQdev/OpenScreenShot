...
| Recordings, reachable from the popup                                                    | ✅ shipped   | Landed in v1.5.0: a Recordings link beside "Reopen last" in the popup footer opens the recorder's session list, which previously had no entry point anywhere. Each row shows the date, duration, file size, source, and which tracks (mic, tab audio, webcam) it holds.                                                                                                                                                                                                                |
...
| Recordings, reachable from the popup                       | v1.5.0  |
